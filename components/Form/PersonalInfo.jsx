		...
		<>
			...
			<fieldset className={utilStyles.noBorder}>
				...
				>
					...
					<div className={personalStyles.labelContainer}>
						<span>Quantity</span>
						{getError(validForm.hasValidQuantity)}
						{console.log(validForm.hasValidQuantity)}
					</div>
					<input
						className={`${personalStyles.inputOne} ${
							!validForm.hasValidQuantity && utilStyles.containerError
						}`}
						type="text"
						value={personalInfo.quantity}
						onChange={handleQuantityChange}
						placeholder="Minum order quantity: 2"
						id="quantity"
						name="quantity"
						// maxLength={32}
					/>
